...
@Component({
  selector: 'app-explore7',
  templateUrl: './explore7.component.html',
  styleUrls: ['./explore7.component.css']
})
export class Explore7Component {
    chart: any;
    graphData: any;
    graphType: number;
    sendGroup: FormGroup;
            ...
            options: {
                  ...
                  scales: {
                      ...
                      y: {
                          title: {
                              display: true,
                              text: 'Percentage Increase of Hospitalizations/Fatalities (%)'
                          }
                      }
                  }
            }  
